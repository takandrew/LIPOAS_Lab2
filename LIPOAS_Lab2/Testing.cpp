...
void Testing()
{
	...
	GasData record2 = GasData{ 1974, 10, 1, "Arco", 32455, 57.9,
	...
	GasData testRecord1 = GasData{ 1974, 3, 27, "Texaco", 24370, 59.9,
		13.5, 8.00, 8085, 598.89,
		13.5, 27.75, 16.45 };
	...
	GasData record3 = GasData{ 1974, 8, numZero, "", 28505, 60.59,
		11.63, 7.02, 264, 25.67,
		11.63, 5.07, 3.08 };
	GasData record4 = GasData{ numZero, numZero, numZero, "", 28252, 60.17,
		11.71, 7.03, 245, 22.77,
		11.42, 5.36, 3.23 };
	...
	GasData record5 = GasData{ 1974, 8, 31, "Exxon", 30643, 56.9,
		13.3, 7.6, 235, 17.67,
		13.3, 4.61, 2.64 };
	GasData record6 = GasData{ 1974, 9, 6, "Shell", 30878, 59.9,
		13.2, 7.9, 304, 23.04,
		13.2, 4.31, 2.58 };
	GasData record7 = GasData{ 1974, 9, 10, "Shell", 31182, 59.9,
		13, 7.8, 285, 21.93,
		13, 4.36, 2.62 };
	dataVector.push_back(record5); dataVector.push_back(record6); dataVector.push_back(record7);

	GasData record8 = GasData{ 0, 0, 0, "Exxon", 30643, 56.9,
		13.3, 7.6, 235, 17.68,
		13.3, 4.62, 2.64 };
	GasData record9 = GasData{ 0, 0, 0, "Shell", 31030, 59.9,
		13.1, 7.85, 294, 22.49,
		13.1, 4.34, 2.6 };
